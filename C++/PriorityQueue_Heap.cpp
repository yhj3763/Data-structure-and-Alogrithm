...
//It is function to compare priority between two data
...
//From here, it is implementing Priority Queue based on Heap
//Heap has almost similar structure with priority queue, all functions implement functions from heap
class PQueue {
public:
	PQueue();						//Constructor
	bool PQIsEmpty();				//Check whether Priority Queue is empty

	void PEnqueue(Data value);		//Adding data into Priority Queue
	Data PDequeue();				//Deleting data into Priority Queue

private: 
	Heap h;							
};

//It is constructor for priority queue
PQueue::PQueue() {
	h = Heap();					
}

//It is function to check whether Priority Queue is empty
bool PQueue::PQIsEmpty() {


	return h.isEmpty();
}

//It is function to add data into Priority Queue
void PQueue::PEnqueue(Data value) {
	h.insert(value);
}

//It is function to delete data into Priority Queue
Data PQueue::PDequeue() {
	return h.remove();
}
